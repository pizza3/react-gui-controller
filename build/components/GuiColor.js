    ...
    function GuiColor() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GuiColor.__proto__ || Object.getPrototypeOf(GuiColor)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            window.onmousemove = function (e) {
                if (this.state.drag && this.state.checkBlock) {
                    this.handleMove(e);
                }
            }.bind(_this);
            ...
            window.onmousemove = function (e) {
                if (this.state.drag && this.state.checkStrip) {
                    this.handleMoveStrip(e);
                }
            }.bind(_this);
            window.onmouseup = function () {
                this.setState({
        ...
        }, _this.handleMoveStrip = function (e) {
            var path = _this.props.path;
            var _this$state2 = _this.state,
                color = _this$state2.color,
                rgb = _this$state2.rgb;
    ...
    _createClass(GuiColor, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement('div', { onClick: this.handleHide, className: 'jsx-' + _colorStyles.colorStyle.__scopedHash + ' ' + _style2.default.dynamic([['3731249671', [this.state.color, this.state.pos.x - 5, this.state.pos.y - 5, this.props.theme === 'dark' ? '#fff' : '#ccc', this.state.hueNob, -2, this.state.posStrip.y - 5, this.state.color, this.props.theme === 'dark' ? '#424242' : 'rgb(229, 229, 229)']]]) + ' ' + 'pallete'
                }),
                _react2.default.createElement(
                    'div',
                    {
                        className: 'jsx-' + _colorStyles.colorStyle.__scopedHash + ' ' + _style2.default.dynamic([['3731249671', [this.state.color, this.state.pos.x - 5, this.state.pos.y - 5, this.props.theme === 'dark' ? '#fff' : '#ccc', this.state.hueNob, -2, this.state.posStrip.y - 5, this.state.color, this.props.theme === 'dark' ? '#424242' : 'rgb(229, 229, 229)']]]) + ' ' + 'contain'
                    },
                    _react2.default.createElement(
                        'div',
                        {
                            className: 'jsx-' + _colorStyles.colorStyle.__scopedHash + ' ' + _style2.default.dynamic([['3731249671', [this.state.color, this.state.pos.x - 5, this.state.pos.y - 5, this.props.theme === 'dark' ? '#fff' : '#ccc', this.state.hueNob, -2, this.state.posStrip.y - 5, this.state.color, this.props.theme === 'dark' ? '#424242' : 'rgb(229, 229, 229)']]]) + ' ' + ((this.props.theme === 'dark' ? 'block-parent block-parent-dark' : 'block-parent') || '')
                        },
                        _react2.default.createElement('canvas', {
                            ...
                            className: 'jsx-' + _colorStyles.colorStyle.__scopedHash + ' ' + _style2.default.dynamic([['3731249671', [this.state.color, this.state.pos.x - 5, this.state.pos.y - 5, this.props.theme === 'dark' ? '#fff' : '#ccc', this.state.hueNob, -2, this.state.posStrip.y - 5, this.state.color, this.props.theme === 'dark' ? '#424242' : 'rgb(229, 229, 229)']]]) + ' ' + 'color-block'
                        }),
                        _react2.default.createElement('div', {
                            ...
                            onMouseDown: this.handleDown,
                            onMouseUp: this.handleUp,
                            className: 'jsx-' + _colorStyles.colorStyle.__scopedHash + ' ' + _style2.default.dynamic([['3731249671', [this.state.color, this.state.pos.x - 5, this.state.pos.y - 5, this.props.theme === 'dark' ? '#fff' : '#ccc', this.state.hueNob, -2, this.state.posStrip.y - 5, this.state.color, this.props.theme === 'dark' ? '#424242' : 'rgb(229, 229, 229)']]]) + ' ' + 'block'
                        })
                    ),
                    _react2.default.createElement(
                        'div',
                        {
                            className: 'jsx-' + _colorStyles.colorStyle.__scopedHash + ' ' + _style2.default.dynamic([['3731249671', [this.state.color, this.state.pos.x - 5, this.state.pos.y - 5, this.props.theme === 'dark' ? '#fff' : '#ccc', this.state.hueNob, -2, this.state.posStrip.y - 5, this.state.color, this.props.theme === 'dark' ? '#424242' : 'rgb(229, 229, 229)']]]) + ' ' + 'strip-parent'
                        },
                        _react2.default.createElement('canvas', {
                            ...
                            onMouseUp: this.handleUp,
                            className: 'jsx-' + _colorStyles.colorStyle.__scopedHash + ' ' + _style2.default.dynamic([['3731249671', [this.state.color, this.state.pos.x - 5, this.state.pos.y - 5, this.props.theme === 'dark' ? '#fff' : '#ccc', this.state.hueNob, -2, this.state.posStrip.y - 5, this.state.color, this.props.theme === 'dark' ? '#424242' : 'rgb(229, 229, 229)']]]) + ' ' + 'color-strip'
                        }),
                        _react2.default.createElement('div', {
                            name: 'strip',
                            onMouseDown: this.handleDownStrip,
                            onMouseUp: this.handleUp,
                            className: 'jsx-' + _colorStyles.colorStyle.__scopedHash + ' ' + _style2.default.dynamic([['3731249671', [this.state.color, this.state.pos.x - 5, this.state.pos.y - 5, this.props.theme === 'dark' ? '#fff' : '#ccc', this.state.hueNob, -2, this.state.posStrip.y - 5, this.state.color, this.props.theme === 'dark' ? '#424242' : 'rgb(229, 229, 229)']]]) + ' ' + 'block-strip'
                        })
                    )
                ),
